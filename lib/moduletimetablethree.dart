...
List<Appointment> getAppointments() {
  ...
  meetings.add(Appointment(
      startTime: DateTime(2023, 6, 22, 8, 0, 0),
      endTime: DateTime(2023, 6, 22, 9, 0, 0),
      subject: 'TUT [01]',
...
meetings.add(Appointment(
      ...
      endTime: DateTime(2023, 6, 22, 10, 0, 0),
      subject: 'TUT [09]',
      color: Colors.blueAccent,
      recurrenceRule: 'FREQ=DAILY;INTERVAL=7;COUNT=10'));
meetings.add(Appointment(
      startTime: DateTime(2023, 6, 22, 10, 0, 0),
  ...
  meetings.add(Appointment(
      ...
      endTime: DateTime(2023, 6, 22, 12, 0, 0),
      subject: 'TUT [02]',
      color: Colors.blueAccent,
      recurrenceRule: 'FREQ=DAILY;INTERVAL=7;COUNT=10'));
meetings.add(Appointment(
  ...
  meetings.add(Appointment(
      ...
      recurrenceRule: 'FREQ=DAILY;INTERVAL=7;COUNT=10'));
meetings.add(Appointment(
      startTime: DateTime(2023, 6, 22, 14, 0, 0),
  ...
  meetings.add(Appointment(
      ...
      endTime: DateTime(2023, 6, 22, 16, 0, 0),
      subject: 'TUT [04]',
      color: Colors.blueAccent,
      recurrenceRule: 'FREQ=DAILY;INTERVAL=7;COUNT=10'));
