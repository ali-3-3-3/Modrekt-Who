...
class DetailThree extends StatelessWidget {
  const DetailThree({Key? key, required this.title}) : super(key:key);
  final String title;
  @override
      ...
      body: ListView(
          children: [
            ...
            const Text(
              ...
              const Text('If undertaking an Undergraduate Degree THEN ( must not have completed 1 of DSA1101/DSC1007/DSC1007X/DSE1101/EC2303/ST1131 at a grade of at least D)',
              ),
            extraInfo,
            timetableWording,
            GestureDetector(
