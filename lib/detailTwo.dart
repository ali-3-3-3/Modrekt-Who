...
class DetailTwo extends StatelessWidget {
  const DetailTwo({Key? key, required this.title}) : super(key:key);
  final String title;
  @override
      ...
      body: ListView(
          children: [
            ...
            const Text(
              ...
              const Text('If undertaking an Undergraduate Degree THEN ( must not have completed 1 of CS1010/CS1010A/CS1010E/CS1010J/CS1010X/CS1101S at a grade of at least D)',
              ),
            extraInfo,
            timetableWording,
            GestureDetector(
