...
class Module {
  ...
  Module(this.title, this.faculty, this.description, this.prerequisite,
  this.preclusion, this.exam, this.ticks, this.workload,
  this.lectureTime, this.tutorialTime, this.labTime);
...
List<Module> moduleList = [
  ...
  Module('CS1010S Programming Methodology', 
    ...
    ['Graded', 'Semester 1 Exam', '27-Nov-2023 1:00 PM • 2 hrs', 'Semester 2 Exam', '30-Apr-2024 1:00 PM • 2 hrs'],
    ['SU', 'SEM1', 'SEM2'],
    ['Lec', 'Lec', 'Tut', 'Lab', 'Project','Project','Project','Prep', 'Prep', 'Prep'],
  ...
  Module('AC5001 Architectural History of Singapore', 
    ...
    ['Graded', 'No Exam'],
    [],
    ['Lec', 'Lec', 'Tut', 'Project', 'Project','Project','Project','Project', 'Prep', 'Prep'],
    [[DateTime(2023, 7, 19, 14, 0, 0),DateTime(2023, 7, 19, 17, 0, 0)]],
    [[DateTime(2023, 7, 20, 9, 0, 0), DateTime(2023, 7, 20, 9, 0, 0)]],
    [[DateTime(2023, 7, 20, 9, 0, 0), DateTime(2023, 7, 20, 9, 0, 0)]],
    ),

  Module('BT1101 Introduction to Business Analytics', 
    ...
    ['Graded', 'Semester 1 Exam', '30-Nov-2023 1:00 PM • 2.5 hrs', 'Semester 2 Exam', '30-Apr-2024 5:00 PM • 2.5 hrs'],
    ['SU', 'SEM1', 'SEM2'],
    ['Lec', 'Lec', 'Tut', 'Lab', 'Lab','Project','Project','Prep', 'Prep', 'Prep'],
  ...
  Module('MA1521 Calculus for Computing', 
    ...
    ['Graded', 'Semester 1 Exam', '28-Nov-2023 9:00 AM • 2 hrs', 'Semester 2 Exam', '02-May-2024 9:00 AM • 2 hrs'],
    ['SU', 'SEM1', 'SEM2'],
    ['Lec', 'Lec', 'Lec', 'Tut', 'Prep','Prep','Prep','Prep', 'Prep', 'Prep'],
    [[DateTime(2023, 7, 17, 12, 0, 0), DateTime(2023, 7, 17, 13, 0, 0)], 
    [DateTime(2023, 7, 17, 13, 0, 0), DateTime(2023, 7, 17, 14, 0, 0)],
    [DateTime(2023, 7, 17, 14, 0, 0), DateTime(2023, 7, 17, 15, 0, 0)], 
  ...
  Module('CS2040 Data Structures and Algorithms',
    ...
    ['Graded', 'Semester 1 Exam', '01-Dec-2023 2:30 PM • 2 hrs', 'Semester 2 Exam', '03-May-2024 2:30 PM • 2 hrs'],
    ['SEM1', 'SEM2'],
    ['Lec', 'Lec', 'Lec', 'Lab', 'Project','Project','Project','Prep', 'Prep', 'Prep'],
    [[DateTime(2023, 7, 19, 10, 0, 0), DateTime(2023, 7, 19, 12, 0, 0)], 
  ...
  Module('IS1108 Digital Ethics and Data Privacy', 
    'Information Systems and Analytics • 4 Units',
    ...
    ['Graded', 'No Exam'],
    ['SU', 'SEM1', 'SEM2'],
    ['Lec', 'Lec', 'Tut', 'Tut', 'Project','Project','Prep','Project', 'Prep', 'Prep'],
  ...
  Module('CS2030S Programming Methodology II',
    'Computer Science • 4 Units',
    ...
    ['Graded', 'Semester 1 Exam', '04-Dec-2023 9:00 AM • 2 hrs', 'Semester 2 Exam', '02-May-2024 1:00 PM • 2 hrs'],
    ['SEM1', 'SEM2'],
    ['Lec', 'Lec', 'Tut', 'Lab', 'Lab','Project','Project','Project', 'Prep', 'Prep'],
    [[DateTime(2023, 7, 19, 14, 0, 0), DateTime(2023, 7, 19, 16, 0, 0)]],
    [[DateTime(2023, 7, 17, 12, 0, 0), DateTime(2023, 7, 17, 13, 0, 0)], 
    [DateTime(2023, 7, 17, 13, 0, 0), DateTime(2023, 7, 17, 14, 0, 0)],
    [DateTime(2023, 7, 17, 14, 0, 0), DateTime(2023, 7, 17, 15, 0, 0)], 
